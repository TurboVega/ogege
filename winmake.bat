...
set TOP=ogege
set VLOG_SRC=src/ogege.v src/char_gen.v src/vga_core.v src/component_blender.v src/color_blender.v src/char_gen.v
set VLOG_SRC=%VLOG_SRC% src/char_blender.v ../fpgalibs/clocks/gatemate_25MHz_pll.v
